...
/****** Object:  StoredProcedure [dbo].[usp_save_publisher]    Script Date: 12/08/2015 11:50:42 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[usp_save_publisher]
...
SET @v_id = NULL
exec usp_save_publisher @v_id OUTPUT, 'Random House', '1234 Broadway', '913-555-1212', 'email@email.com', 1
